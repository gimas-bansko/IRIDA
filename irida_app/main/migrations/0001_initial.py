# Generated by Django 4.2.24 on 2025-09-04 19:40
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('grade', models.PositiveSmallIntegerField(blank=True, default=11, null=True, validators=[django.core.validators.MinValueValidator(8), django.core.validators.MaxValueValidator(12)], verbose_name='Клас')),
                ('section', models.CharField(blank=True, default='а', max_length=1, null=True, verbose_name='Паралелка')),
            ],
            options={
                'verbose_name': 'Клас',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('plan', models.FileField(blank=True, upload_to='docs/', verbose_name='Учебен план')),
