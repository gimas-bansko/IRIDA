...
--
-- Хост: 127.0.0.1
-- Време на генериране:  9 март 2026 в 03:25
...
(1, 'pbkdf2_sha256$600000$3iNEHTkQ6rkF6v46il2Dsp$wzYrjzST0uYMRVFUzIBCXDqFWdbed8vyiQCqZ39eB9o=', '2026-03-08 20:43:36.571055', 1, 'superadmin', 'Георги', 'Бориков', '', 1, 1, '2025-09-04 19:41:42.000000'),
...
('rrqct5ftw5c96z59i0crqa11y2fywlak', '.eJxVjEsOwjAMBe-SNYqckDoNS_Y9Q2XHDi2gVOpnhbg7VOoCtm9m3sv0tK1Dvy0696OYi3Hm9Lsx5YfWHcid6m2yearrPLLdFXvQxXaT6PN6uH8HAy3Dt4aEiBoK5aAJYgNAUBiRmaMQu9SAOJdbiS76tlDwuSCKtl5SOJOa9wflkTgu:1vyZ81:GELZM_xJOe3X1571l_fTDFT1UpR6V0o5jmTudDna70s', '2026-03-20 17:38:21.390205'),
...
(6, 'Самостоятелна практика', '(Практическа задача', 25, 1, 6, '<p><strong>Задача:</strong></p><p style=\"margin-left:40px;\">„Създайте клас Animal с полета (например name, age), свойства за всяко поле, и поне два метода (напр. CelebrateBirthday, Speak).“</p><p>Упътване:&nbsp;</p><p style=\"margin-left:40px;\">Дава се шаблон/пример, ако някой има нужда. Учителят обикаля и подпомага индивидуално.</p>'),
